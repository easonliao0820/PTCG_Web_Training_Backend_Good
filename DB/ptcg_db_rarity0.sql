...
INSERT INTO `rarity` VALUES (1,'C','常見'),(2,'U','不常見'),(3,'R','稀有'),(4,'RR','雙重稀有'),(5,'RRR','三重稀有'),(6,'SR','非常稀有'),(7,'HR','超級稀有'),(8,'UR','極其稀有'),(9,'PR','稜鏡之星稀有'),(10,'TR','訓練家稀有'),(11,'Amazing Rare','奇幻稀有(小色違)'),(12,'K','光輝'),(13,'CHR','角色稀有'),(14,'CSR','角色非常稀有'),(15,'S','異色'),(16,'SSR','異色非常稀有'),(17,'AR','藝術稀有'),(18,'SAR','特殊藝術稀有'),(19,'ACE','ACE SPEC'),(20,'MUR','超級進化額外稀有'),(21,'MA','超級進化藝術稀有');
