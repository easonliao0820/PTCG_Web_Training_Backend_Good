...
INSERT INTO `specal_card_type` VALUES (1,'EX','寶可夢EX'),(2,'EX-Mega Evolution Pokémon','寶可夢EX-M进化寶可夢'),(3,'BREAK','BREAK進化寶可夢'),(4,'GX','寶可夢GX'),(5,'GX-TAG TEAM','寶可夢GX-TAG TEAM'),(6,'Prism Star','稜鏡之星'),(7,'V','寶可夢V'),(8,'VMAX','寶可夢VMAX'),(9,'V-UNION','寶可夢V-UNION'),(10,'VSTAR','寶可夢VSTAR'),(11,'Radiant','光輝寶可夢'),(12,'EX-Tera','寶可夢EX-太晶'),(13,'EX-Mega Evolution','寶可夢EX-超級進化'),(14,'normal','普卡');
