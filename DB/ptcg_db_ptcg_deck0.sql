...
--
-- Table structure for table `ptcg_deck`
--

DROP TABLE IF EXISTS `ptcg_deck`;
...
--
-- Dumping data for table `ptcg_deck`
--

LOCK TABLES `ptcg_deck` WRITE;
/*!40000 ALTER TABLE `ptcg_deck` DISABLE KEYS */;
/*!40000 ALTER TABLE `ptcg_deck` ENABLE KEYS */;
UNLOCK TABLES;
